package com.blockchain.server.cct.common.interceptor;
...
public class InterceptorConf implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(loginInterceptor())
                ...
                .excludePathPatterns("/order/listBuyOrder")
                .excludePathPatterns("/order/listSellOrder")
                .excludePathPatterns("/record/listRecord")
