package com.blockchain.server.cct.redis;
...
public class PublishOrderCache {
    ...
    private static final int LOCK_WAIT_TIME = 0; //获取锁等待时间
     ...
     * @return
     */
    public boolean tryFairLock(RedissonClient redissonClient, String coinName, String unitName, String orderType) {
     ...
     * @param orderType
     */
    public void unFairLock(RedissonClient redissonClient, String coinName, String unitName, String orderType) {
