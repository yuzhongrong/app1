...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_application`;
CREATE TABLE `dapp_teth_application`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_block_number`;
CREATE TABLE `dapp_teth_block_number`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_clearing_corr`;
CREATE TABLE `dapp_teth_clearing_corr`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_clearing_count_detail`;
CREATE TABLE `dapp_teth_clearing_count_detail`  (
  `id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_clearing_count_total`;
CREATE TABLE `dapp_teth_clearing_count_total`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_clearing_detail`;
CREATE TABLE `dapp_teth_clearing_detail`  (
  `id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
  `total_id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '期初期末记录id',
  `transfer_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '变动类型',
  `transfer_amount` decimal(20, 8) NOT NULL COMMENT '变动总金额,正负数',
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_clearing_total`;
CREATE TABLE `dapp_teth_clearing_total`  (
  `id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `user_id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户id',
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_collection_transfer`;
CREATE TABLE `dapp_teth_collection_transfer`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_gas_wallet`;
CREATE TABLE `dapp_teth_gas_wallet`  (
  `addr` varchar(44) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '钱包地址',
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_paradrop`;
CREATE TABLE `dapp_teth_paradrop`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_paradrop_addr`;
CREATE TABLE `dapp_teth_paradrop_addr`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_private_balance`;
CREATE TABLE `dapp_teth_private_balance`  (
  `id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_to_addr`;
CREATE TABLE `dapp_teth_to_addr`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_token`;
CREATE TABLE `dapp_teth_token`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_transfer_auditing`;
CREATE TABLE `dapp_teth_transfer_auditing`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_wallet`;
CREATE TABLE `dapp_teth_wallet`  (
  `addr` varchar(44) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ETH托管钱包地址',
  `token_addr` varchar(44) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '币种地址',
  `user_open_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户id',
  `token_symbol` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_wallet_blocked_detail`;
CREATE TABLE `dapp_teth_wallet_blocked_detail`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_wallet_blocked_total`;
CREATE TABLE `dapp_teth_wallet_blocked_total`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_wallet_key`;
CREATE TABLE `dapp_teth_wallet_key`  (
  `user_open_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户id',
  `addr` varchar(44) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '钱包地址',
  `private_key` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '托管钱包私钥',
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_wallet_out`;
CREATE TABLE `dapp_teth_wallet_out`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `dapp_teth_wallet_transfer`;
CREATE TABLE `dapp_teth_wallet_transfer`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `hash` varchar(66) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '充值或提现需保存的hash值',
  `from_addr` varchar(44) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '支付人地址',
  `to_addr` varchar(44) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '收款人地址',
