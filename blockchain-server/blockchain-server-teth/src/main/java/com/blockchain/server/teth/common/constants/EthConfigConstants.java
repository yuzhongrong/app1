...
//    public static final String MODULE_TYPE_USDT="USDT";//USDT地址
    public static final String MODULE_TYPE = "teth"; // 所属于钱包模块
    public static final String MODULE_TYPE_USDT = "USDT";//TUSDT地址
    ...
    public static class EthGasConfig {
        //        public static final String PARAM_NAME = "eth_gas_config_"; // 参数名称
                  public static final String PARAM_NAME = "teth_gas_config_"; // 参数名称
    }
}
