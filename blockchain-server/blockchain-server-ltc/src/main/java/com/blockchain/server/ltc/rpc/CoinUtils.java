...
public class CoinUtils {
    ...
    public String getNewAddress() throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getNewAddress():{} ===", e.getMessage(), e);
    ...
    public boolean validateAddress(String address) throws Exception {
        try {
            JSONObject vali = client.getClient().invoke("validateaddress", new Object[]{address}, JSONObject.class);
            return vali.getBooleanValue("isvalid");
        } catch (Throwable e) {
     ...
     * @throws Exception
     */
    public JSONObject getAddressInfo(String address) throws Exception {
        try {
            return client.getClient().invoke("getaddressinfo", new Object[]{address}, JSONObject.class);
        } catch (Throwable e) {
            LOG.info("=== CoinUtils.getaddressinfo(String):{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage() + String.format("[params]: address=%s", address));
        }
    }
    ...
    public double getBalance(String account) throws Exception {
        ...
        try {
            if (!StringUtils.isEmpty(account)) {
                ...
                balance = client.getClient().invoke("getbalance", null, Double.class);
            }
        } catch (Throwable e) {
    ...
    public String sendToAddress(String toAddress, String amount) throws Exception {
        try {
            ...
            throw new Exception(e.getMessage() + String.format("[params]: toAddress=%s, amount=%s", toAddress, amount));
        }
    }
    ...
    public boolean backupWallet(String destination) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.backupWallet(String):{} ===", e.getMessage(), e);
    ...
    public boolean importWallet(String filename) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.importWallet(String):{} ===", e.getMessage(), e);
    ...
    public Integer getBlockCount() throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getBlockCount():{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage());
        }
    }
...
//            return balance;
    ...
    public void unLockUnspent() throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.unLockUnspent():{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage());
        }
    }
