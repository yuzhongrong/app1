...
-- ----------------------------
-- Table structure for dapp_ltc_application
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_application`;
CREATE TABLE `dapp_ltc_application`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_block_number
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_block_number`;
CREATE TABLE `dapp_ltc_block_number`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_clearing_corr
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_clearing_corr`;
CREATE TABLE `dapp_ltc_clearing_corr`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_clearing_count_detail
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_clearing_count_detail`;
CREATE TABLE `dapp_ltc_clearing_count_detail`  (
  `id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
...
-- ----------------------------
-- Table structure for dapp_ltc_clearing_count_total
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_clearing_count_total`;
CREATE TABLE `dapp_ltc_clearing_count_total`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_clearing_detail
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_clearing_detail`;
CREATE TABLE `dapp_ltc_clearing_detail`  (
  `id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
  `total_id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '期初期末记录id',
  `transfer_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '变动类型',
  `transfer_amount` decimal(20, 8) NOT NULL COMMENT '变动总金额,正负数',
...
-- ----------------------------
-- Table structure for dapp_ltc_clearing_total
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_clearing_total`;
CREATE TABLE `dapp_ltc_clearing_total`  (
  `id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `user_id` char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for dapp_ltc_collection_transfer
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_collection_transfer`;
CREATE TABLE `dapp_ltc_collection_transfer`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_token
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_token`;
CREATE TABLE `dapp_ltc_token`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_transfer_auditing
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_transfer_auditing`;
CREATE TABLE `dapp_ltc_transfer_auditing`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
-- Table structure for dapp_ltc_wallet
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_wallet`;
CREATE TABLE `dapp_ltc_wallet`  (
  `addr` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'btc托管钱包地址',
  `token_id` int(11) NOT NULL COMMENT 'BTC为0，USDT为31',
...
-- ----------------------------
-- Table structure for dapp_ltc_wallet_blocked_detail
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_wallet_blocked_detail`;
CREATE TABLE `dapp_ltc_wallet_blocked_detail`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_wallet_blocked_total
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_wallet_blocked_total`;
CREATE TABLE `dapp_ltc_wallet_blocked_total`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
  `wallet_uid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '钱包唯一标识(地址|id)',
  `token_symbol` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '代币名称',
  `user_open_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for dapp_ltc_wallet_key
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_wallet_key`;
CREATE TABLE `dapp_ltc_wallet_key`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_wallet_out
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_wallet_out`;
CREATE TABLE `dapp_ltc_wallet_out`  (
...
-- ----------------------------
-- Table structure for dapp_ltc_wallet_transfer
-- ----------------------------
DROP TABLE IF EXISTS `dapp_ltc_wallet_transfer`;
CREATE TABLE `dapp_ltc_wallet_transfer`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
