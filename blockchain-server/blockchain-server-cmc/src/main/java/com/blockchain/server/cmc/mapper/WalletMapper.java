...
public interface WalletMapper extends Mapper<Wallet> {
     ...
     * @return
     */
    WalletDTO selectByUserOpenId(@Param("userOpenId") String userOpenId, @Param("tokenId") Integer tokenId, @Param("walletType") String walletType);
     ...
     * @return
     */
    WalletDTO selectByAddr(@Param("addr") String addr, @Param("tokenId") Integer tokenId, @Param("walletType") String walletType);
     ...
     * @return
     */
    List<WalletDTO> selectAllByUserOpenId(@Param("userOpenId") String userOpenId, @Param("walletType") String walletType);
