...
public interface BtcWalletService {
     ...
     * @return
     */
    BtcWalletDTO selectByUserOpenId(String userOpenId, Integer tokenId, String walletType);
     ...
     * @return
     */
    BtcWalletDTO selectByAddr(String addr, Integer tokenId, String walletType);
     ...
     * 应用提现失败业务
     *
     * @param btcWalletTransfer 提现记录
     */
    void updateTxOutError(BtcWalletTransfer btcWalletTransfer);
     ...
     * @param btcWalletTransfer 提现记录
     */
    void updateTxOutSuccess(BtcWalletTransfer btcWalletTransfer);
     ...
     * @return
     */
    BtcWallet findWallet(String userId, String walletType, String coinName);
     ...
     * @return
     */
    ResultDTO handleTransfer(String userId, String fromType, String toType, String coinName, BigDecimal amount);
