package com.blockchain.server.eos.common.config;

import com.blockchain.server.eos.scheduleTask.TransferDisposeTimerTask;
import com.blockchain.server.eos.scheduleTask.WallertTimerTask;
    ...
    public ApplicationRunner applicationRunner() {
        return new ApplicationRunner() {
            ...
            public void run(ApplicationArguments args) throws Exception {
                if (scheduleOpen) {
                    schedule(() -> transferDisposeTimerTask.selectTxStatus(), TransferDisposeTimerTask.SELECT_TX_STATUS_CRON);
