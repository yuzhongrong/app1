...
public class TxManagerController {
    ...
    public String sendMsg(@RequestParam("msg") String msg,@RequestParam("entity") String model) {
        return apiTxManagerService.sendMsg(model,msg);
    }


    @RequestMapping("/sendCompensateMsg")
    public boolean sendCompensateMsg(@RequestParam("entity") String model, @RequestParam("uniqueKey") String uniqueKey,
