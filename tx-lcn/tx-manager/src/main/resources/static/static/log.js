var init = function () {
    ...
    http.get('/admin/modelList', '加载数据...', function (res) {
        ...
        for (var p in res) {
            ...
            var tr = '<tr>' +
                '<td><a class="entity-name" href="#">' + name + '</a></td>' +
...
$(document).on("click", ".entity-name", function () {
    var model = $(this).text();

    $('#entity').attr("data-entity", model);

    http.get('/admin/modelTimes?entity=' + model, '加载数据...', function (res) {
        ...
        for (var p in res) {
            ...
            var tr = '<tr><td><a class="entity-time" data-data="' + data + '" href="#">' + name + '</a></td></tr>';
            list.append(tr);
        }
...
$(document).on("click", ".entity-time", function () {

    var file = $(this).attr("data-data");

    var path = $('#entity').attr("data-entity") + ":" + file;
